    ...
    Private Sub BtnSaveTemplate_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BtnSaveTemplate.Click
        Try
            ...
            If String.IsNullOrEmpty(TxtTplFab.Text) Or HaveCaractSpecial(TxtTplFab.Text) Then
                MessageBox.Show("Le nom du fabricant est obligatoire et ne doit pas comporter de caractère spécial (%,-,!...) ", "Erreur", MessageBoxButton.OK, MessageBoxImage.Exclamation)
                TxtTplFab.Focus()
                Exit Sub
            End If
            If String.IsNullOrEmpty(TxtTplMod.Text) Or HaveCaractSpecial(TxtTplMod.Text) > 0 Then
                MessageBox.Show("Le nom du modèle est obligatoire et ne doit pas comporter de caractère spécial (%,-,!...)", "Erreur", MessageBoxButton.OK, MessageBoxImage.Exclamation)
                TxtTplMod.Focus()
                Exit Sub
            End If
