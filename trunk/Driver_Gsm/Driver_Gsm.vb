        ...
        Try
            ...
            Select Case UCase(Command)
                ...
                Case "CALL"
                    ...
                    End Select
                    _Server.Log(Server.TypeLog.INFO, Server.TypeSource.DRIVER, "GSM Write CALL", "Appel Imposible : aucun mode selectionné")
                Case Else
