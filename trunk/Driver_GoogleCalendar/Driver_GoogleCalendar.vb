...
''' <summary>Class Driver_GoogleCalendar</summary>
''' <remarks>Permet de récupérer des évènements dans vos calendriers google</remarks>
...
#Region "Variables génériques"
    ...
    Dim _ID As String = "D4AF0FAC-D1D3-11E1-8F5E-E82F6188709B" 'ne pas modifier car utilisé dans le code du serveur
    Dim _Nom As String = "GoogleCalendar" 'Nom du driver à afficher
    Dim _Enable As String = False 'Activer/Désactiver le driver
    Dim _Description As String = "Permet de récupérer des évènements depuis un calendrier Google" 'Description du driver
    ...
    Dim _Modele As String = "GoogleCalendar" 'Modèle du driver/interface
...
#Region "Fonctions génériques"
    ...
    Public Sub New()
        Try
            ...
            'Libellé Device
            Add_LibelleDevice("ADRESSE1", "Nom du calendrier", "")
            Add_LibelleDevice("ADRESSE2", "Titre de l'évènement", "")
            Add_LibelleDevice("SOLO", "@", "")
            Add_LibelleDevice("MODELE", "@", "")
            Add_LibelleDevice("REFRESH", "Refresh", "Durée entre deux intérrogations du calendrier")
    ...
    Private Sub WriteLog(ByVal message As String)
        Try
            ...
            If STRGS.InStr(message, "DBG:") > 0 Then
                _Server.Log(TypeLog.DEBUG, TypeSource.DRIVER, "GoogleCalendar", STRGS.Right(message, message.Length - 5))
            ElseIf STRGS.InStr(message, "ERR:") > 0 Then
                _Server.Log(TypeLog.ERREUR, TypeSource.DRIVER, "GoogleCalendar", STRGS.Right(message, message.Length - 5))
            Else
                _Server.Log(TypeLog.INFO, TypeSource.DRIVER, "GoogleCalendar", message)
            End If
        Catch ex As Exception
            _Server.Log(TypeLog.ERREUR, TypeSource.DRIVER, "GoogleCalendar WriteLog", ex.Message)
        End Try
    End Sub
#End Region
