...
<Serializable()> Public Class Driver_OpenWebNet_IP
...
#Region "Variables internes"
    Dim GatewayCommand As OpenWebNet.WebServer
    Dim GatewayMonitor As OpenWebNet.WebServer
#End Region
        ...
        Try
            ...
            Select Case Objet.Type
                Case "APPAREIL", "LAMPE"
                    Select Case UCase(Command)
                        Case "ON"
                            GatewayCommand.LightingLightON(Objet.Adresse1)
                            Objet.value = True
                        Case "OFF"
                            GatewayCommand.LightingLightOFF(Objet.Adresse1)
                            Objet.value = False
                        Case "DIM"
                            GatewayCommand.LightingDimmerStrenght(Objet.Adresse1, Parametre1)
