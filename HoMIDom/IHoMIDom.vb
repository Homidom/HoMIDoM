...
Namespace HoMIDom
    ...
    Public Interface IHoMIDom
        ...
        '---- Fonctions ---------------------------------------
        Function AddDeviceToZone(ByVal ZoneId As String, ByVal DeviceId As String, ByVal Visible As Boolean, Optional ByVal X As Double = 0, Optional ByVal Y As Double = 0) As String 'ajouter un device à une zone
        ...
        Function SaveZone(ByVal zoneId As String, ByVal name As String, Optional ByVal ListDevice As ArrayList = Nothing, Optional ByVal icon As String = "", Optional ByVal image As String = "") As String 'Créer un nouveau zone ou sauvegarder la modif (si ID est complété)
