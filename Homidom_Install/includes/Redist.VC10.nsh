...
Function DownloadVC10Redist
      ...
      lbl_continue:
        ...
        Banner::show /NOUNLOAD "$(DESC_INSTALLING) $(DESC_VC10_LABEL)..."
...
Function CheckVC10Redist
  ...
  !insertmacro Log_String "$(DESC_VC10_LABEL) :  pas de clé de registre valide trouvé ! vérification de la présence de msvcr100.dll : $IsVC10RedistInstalled"
  Goto exitVC10RedistCheck

VC10RegKeyFound:

  !insertmacro Log_String "$(DESC_VC10_LABEL) : $VC10_RegKey => $VC10RedistRegKeyValue"
  StrCpy $IsVC10RedistInstalled "1"
