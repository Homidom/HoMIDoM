...
#End Region
    ...
    Public Sub New()
        Try
            ...
            If IsConnect = True Then
                LblLeve.Content = myService.GetHeureLeverSoleil 'Mid(hs.Sunrise, 1, 5)
                LblCouche.Content = myService.GetHeureCoucherSoleil  'Mid(hs.Sunset, 1, 5)
            End If
    ...
    Private Sub NewBtnMnu(ByVal Label As String, ByVal Name As String, ByVal Icon As String)
        Try
            Dim ctrl As uCtrlImgMnu = New uCtrlImgMnu
            ctrl.Height = 90
            ctrl.Width = 90
            ctrl.Text = Label
            ctrl.Tag = Name
