    ...
    Public Sub GetAllHueDevices() 'As Task
        ...
        For Each device As Object In resultgethuedevices
            ...
            If (listedevices.Count = 0) Then
                ...
                gen.SaveDevice(_IdSrv, "", "Hue" + device.Name, device.ID.ToString(), True, False, _ID, "GENERIQUESTRING", 0, True, 0, 0, 0, 0, device.State.Hue.ToString(), "", device.State.ColorTemperature.ToString(), "Devices et Valeurs recuperées du Bridge Hue", 0, False, "0", "", 0, 9999, -9999, 0.0, Nothing, "", 0, True, Nothing, Propriete_hue)
